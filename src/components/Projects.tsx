...
const projects = [
  ...
  },
  {
    ...
    description:
      'Foody is a convenient food ordering app where users can explore a variety of delicious burgers, shakes, and more. Users can customize their orders, add special instructions, and enjoy a smooth ordering experience.',
    image: '/assets/ChatGPT Image Apr 12, 2025, 08_00_39 PM.png',
    features: [
    ...
    links: [
      {
        label: 'Live Site',
        icon: ExternalLink,
        url: 'https://foody-beryl.vercel.app/'
      },
      {
        label: 'GitHub',
        icon: Github,
        url: 'https://github.com/pavich5/Foody'
      }
    ],
